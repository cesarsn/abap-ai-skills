...
2. **Mandatory reference:** Use as technical blueprint reference file `./references/test-osql.abap`.
...
2. **Mandatory reference:** Use as technical blueprint reference file `./references/test-ftd.abap`.